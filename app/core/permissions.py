...
PERMISSIONS: list[dict] = [
    ...
    # ---------------- почта
    {
        ...
        "hint": "Раздел «Почта»: читать письма рабочего ящика, отвечать клиентам, получать "
                "уведомления о новых. Ящик один на всех, личных здесь нет.",
        "group": "Почта",
        "default": True,
    },
    {
    ...
    {
        "key": "feedback.send",
        "title": "Писать разработчику",
        "hint": "Раздел «Обратная связь»: сообщить об ошибке, предложить улучшение, "
                "задать вопрос. Ответ приходит туда же.",

...
TEMPLATES: list[dict] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            ("plotter_cut", "Плоттерная резка", "bool", "price", "dop_obrabotka", "per_length",
             "", False, F(price_item="Плоттерная резка", source_field="cut_length")),
            ...
            ("hand_cut", "Ручная обрезка по периметру", "bool", "price", "dop_obrabotka", "per_m",

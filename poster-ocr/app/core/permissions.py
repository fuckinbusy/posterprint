...
PERMISSIONS: list[dict] = [
    ...
    },
    {
        "key": "tools.fonts",
        "title": "Шрифты",
        "hint": "«Инструменты» → найти и скачать шрифт из Google Fonts, узнать, какие шрифты нужны макету .cdr.",
        "group": "Инструменты",
        "default": True,
    },
    {
        "key": "tools.calc",
        "title": "Калькулятор",
        "hint": "«Инструменты» → деньги и курсы ЦБ, метраж, размеры для дизайна, единицы.",
        "group": "Инструменты",
        "default": True,
    },
    # ---------------- администрирование
